...
export const Cgu = () => {
  return (
    <div className="m-5">
      <img src={polynotesLogo} alt="Polynotes" className="w-32" />
      <h1>Website Terms and Conditions of Use</h1>

      <h2>1. Terms</h2>

      <p>
        By accessing this Website, accessible from https://polynotes.cluster-2022-7.dopolytech.fr/, you are agreeing to
        be bound by these Website Terms and Conditions of Use and agree that you are responsible for the agreement with
        any applicable local laws. If you disagree with any of these terms, you are prohibited from accessing this site.
      ...
      <p>
        ...
        inability to use the materials on Polynotes's Website, even if Polynotes or an authorize representative of this
      ...
      <p>
        ...
        Polynotes may change the materials contained on its Website at any time without notice. Polynotes does not make
      ...
      <p>
        Polynotes has not reviewed all of the sites linked to its Website and is not responsible for the contents of any
        such linked site. The presence of any link does not imply endorsement by Polynotes of the site. The use of any
      ...
      <p>
        Polynotes may revise these Terms of Use for its Website at any time without prior notice. By using this Website,
      ...
      <p>
        Any claim related to Polynotes's Website shall be governed by the laws of fr without regards to its conflict of
        law provisions.
      </p>
    </div>
  )
